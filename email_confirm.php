<?php
    ...
    if(isset($_GET['email_confirmation']))
    {
        ...
        if(mysqli_num_rows($query) == 1)
        {
            ...
            {
                echo "<script>alert('E-mail already verified!')</script>";
            }
            else
            {
                ...
                if($update)
                {
                    echo "<script>alert('E-mail verification successful!')</script>"; 
                }
                else
                {
                    echo "<script>alert('E-mail verification failed. Server Down!')</script>"; 
                }
            }
            redirect('index.php');
        }
