<?php
    ...
    $upd_query = "UPDATE `booking_order` SET `booking_status`='payment failed',`trans_status`='TXN_FAILED',`trans_resp_msg`='Sorry! The transaction was unsuccessful' WHERE `booking_id`='$slct_fetch[booking_id]'";
