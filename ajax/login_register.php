<?php
    ...
    function send_mail($uemail,$token,$type)
    {
        ...
        $email->addContent(
            "text/html", 
            "
                <strong>Click the link to $content: </strong><br>
    ...
    if(isset($_POST['register']))
    {
        ...
        //maching password and confirm password field
        ...
        if(mysqli_num_rows($u_exist) != 0)
        {
            ...
            echo ($u_exist_fetch['email'] == $data['email']) ? 'e-mail_already' : 'phone_already';
            exit;
        }
