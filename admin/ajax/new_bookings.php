<?php
            ...
            $table_data .= "
                <tr>
                    ...
                    <td>
                        ...
                        <br>
                        <button type='button' onclick='cancel_booking($data[booking_id])' class='mt-2 btn btn-sm btn-outline-danger fw-bold shadow-none'>
    ...
    if(isset($_POST['assign_room']))
    {
        ...
        echo ($res == 2) ? 1 : 0;   //it will effect 2 rows
    }
